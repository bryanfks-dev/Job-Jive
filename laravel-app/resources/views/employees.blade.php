        ...
        <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex flex-col items-center pb-10 w-full">
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg object-cover"
                    src="https://source.unsplash.com/v6771a4avV4" alt="Chinese man image" />
                <span
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 mt-4 w-full">
        <div
            ...
            <div class="flex justify-center flex-col items-center pb-10">
                ...
                <h5 class="mb-1 text-center text-xl font-medium text-gray-900 dark:text-white">Bryan Fernando</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">bryanfks@gmail.com</span>
        ...
        <div
            ...
            <div class="flex flex-col items-center pb-10">
                <span
                    class="mb-2 bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-800">Employee</span>
                <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Kanz Abdillah</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">kanzah@gmail.com</span>
        ...
        <div
            ...
            <div class="flex flex-col items-center pb-10">
                <span
                    class="mb-2 bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-800">Employee</span>
                <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Wildan Rizkia</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">wildanriz@gmail.com</span>
        ...
        <div
            ...
            <div class="flex justify-center flex-col items-center pb-10">
                <span
                    class="mb-2 bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-800">Employee</span>
                <h5 class="mb-1 text-center text-xl font-medium text-gray-900 dark:text-white">Paris Novitasari</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">parisnovi@gmail.com</span>
        ...
        <div
            ...
            <div class="flex justify-center flex-col items-center pb-10">
                <span
                    class="mb-2 bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-800">Employee</span>
                <h5 class="mb-1 text-center text-xl font-medium text-gray-900 dark:text-white">Cengkal Ardianto</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">cengkal.ardi1@gmail.com</span>
        ...
        <div
            ...
            <div class="flex justify-center flex-col items-center pb-10">
                <span
                    class="mb-2 bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-800">Employee</span>
                <h5 class="mb-1 text-center text-xl font-medium text-gray-900 dark:text-white">Natalia Hassanah</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">natali.hasan7@gmail.com</span>
        ...
        <div
            ...
            <div class="flex justify-center flex-col items-center pb-10">
                <span
                    class="mb-2 bg-green-100 text-green-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-green-200 dark:text-green-800">Employee</span>
                <h5 class="mb-1 text-center text-xl font-medium text-gray-900 dark:text-white">Tasdik Pradipta</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">tasdik812@gmail.com</span>
        ...
        <div
            ...
            <div class="flex justify-center flex-col items-center pb-10">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">cintakuswandari2@gmail.com</span>
