            ...
            <div class="mt-2">
                <div class="items-center block p-3 sm:flex">
                    <img class="w-32 h-32 md:w-40 md:h-40 mb-3 me-3 rounded-full sm:mb-0 object-cover"
                        src="{{ asset('/storage/img/user_profile/' . $profile['photo']) }}" alt="user image" />
                    <div class="text-gray-600 dark:text-gray-400 ml-0 sm:ml-5 mt-4 sm:mt-0">
                        <span class="font-medium text-gray-900 dark:text-white text-2xl">{{ $profile['full_name'] }}</span>
                        <p class="text-md font-normal">{{ $profile['as'] }}</p>
                        <span class="text-xs font-normal text-gray-500 dark:text-gray-400">
                            Since {{ $profile['first_login'] ?? 'N/A' }}
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="w-full py-4 sm:px-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
                        <ul class="space-y-4">
                            <li class="flex flex-col">
                                ...
                                <span class="text-md font-normal truncate">{{ $profile['email'] }}</span>
                            </li>
                            <li class="flex flex-col">
                                <span class="text-sm font-normal text-gray-600 dark:text-gray-400">NIK</span>
                                <span class="text-md font-normal truncate">{{ $profile['nik'] }}</span>
                            </li>
                            <li class="flex flex-col">
                                <span class="text-sm font-normal text-gray-600 dark:text-gray-400">Phone Number</span>
                                <span class="text-md font-normal truncate">{{ $profile['phone_number'] }}</span>
                            </li>
                            <li class="flex flex-col">
                                <span class="text-sm font-normal text-gray-600 dark:text-gray-400">Department</span>
                                <span class="text-md font-normal truncate">{{ $profile['department']['name'] }}</span>
                            </li>
                        </ul>
                    </div>
                    <div class="py-4 sm:px-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
                        <ul class="space-y-4">
                            <li class="flex flex-col">
                                ...
                                <span class="text-md font-normal break-words">{{ $profile['address'] }}</span>
                            </li>
                            <li class="flex flex-col">
