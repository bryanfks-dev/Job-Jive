<div id="crud-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" action="{{ route('admin.users.create') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <div class="grid gap-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="tel" name="phone_number" id="phone_number"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="ex. 081234567890" value="{{ old('phone_number') }}" required="">
                        </div>
                        <div class="col-span-2 sm:col-span-1">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <select name="gender" id="gender"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                required>
                                <option value="" {{ old('gender') == '' ? 'selected' : '' }} hidden disabled>
                                    Select
                                    Gender</option>
                                @php
                                    $genders = ['Male', 'Female'];
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <select name="department_id" id="department_id"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                required>
                                <option value="" {{ old('department_id') == '' ? 'selected' : '' }} disabled
                                    hidden>
                    ...
                    <div class="grid mt-4">
                        <span class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload Photo</span>
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file"
                                ...
                                <input id="dropzone-file" type="file" accept=".png, .jpg, .jpeg" class="hidden"
                                    name="photo" required />
                            </label>
                        </div>
                        {{-- Catch create failed --}}
    ...
    <script class="module">
        // Script to show selected file upload photo
        const PhotoInput = document.querySelector('input[name="photo"]');

        PhotoInput.addEventListener('change', () => {
            PhotoInput.classList.remove('hidden');
            PhotoInput.classList.add('unhidden');
        })
    </script>
</div>
